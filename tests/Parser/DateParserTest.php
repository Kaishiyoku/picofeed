...
class DateParserTest extends TestCase
{
    ...
    public function testParseDate()
    {
        ...
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('############# EST')->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('Wed, 30 Nov -0001 00:00:00 +0000')->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('čet, 24 maj 2012 00:00:00')->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('-0-0T::Z')->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('Wed, 18 2012')->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime("'2009-09-30 CDT16:09:54")->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('ary 8 Jan 2013 00:00:00 GMT')->format(self::DATETIME_FORMAT));
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('Sat, 11 00:00:01 GMT')->format(self::DATETIME_FORMAT));
        ...
        $this->assertEquals($parser->getCurrentDateTime()->format(self::DATETIME_FORMAT), $parser->getDateTime('+0400')->format(self::DATETIME_FORMAT));
    }
}
